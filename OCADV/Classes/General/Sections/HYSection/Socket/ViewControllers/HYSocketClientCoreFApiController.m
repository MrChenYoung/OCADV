...
#import "HYSocketCoreFoundationClient.h"

@interface HYSocketClientCoreFApiController ()

// 客户端socket1
@property (nonatomic, strong) HYSocketCoreFoundationClient *socketCoreClient;

@end

@implementation HYSocketClientCoreFApiController
...
- (void)initSocket
{
    ...
    // 客户端收到消息回调
    self.socketCoreClient = [[HYSocketCoreFoundationClient alloc]init];
