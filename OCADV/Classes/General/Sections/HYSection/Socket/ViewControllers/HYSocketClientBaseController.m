...
#import "HYSocketClientBaseController.h"


@interface HYSocketClientBaseController ()
// 客户端view
@property (nonatomic, strong) HYSocketClientView *clientView;

@end

@implementation HYSocketClientBaseController
...
- (void)viewDidLoad {
    ...
    self.clientView = [[HYSocketClientView alloc]init];
    // 连接服务器
