...
@interface HYSocketCoreFoundationClient ()
...
@implementation HYSocketCoreFoundationClient
...
{
    HYSocketCoreFoundationClient *client = (__bridge HYSocketCoreFoundationClient *)info;
