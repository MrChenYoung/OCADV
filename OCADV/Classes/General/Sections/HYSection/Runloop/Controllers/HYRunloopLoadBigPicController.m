...
@interface HYRunloopLoadBigPicController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HYRunloopLoadBigPicController
...
void callBack(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info){
    HYRunloopLoadBigPicController *ctr = (__bridge HYRunloopLoadBigPicController *)info;
    if (ctr.tasks == 0) {
        return;
    }
...
//    }
    ...
    HYBigPictureCell *cell = [[HYBigPictureCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuserId];
