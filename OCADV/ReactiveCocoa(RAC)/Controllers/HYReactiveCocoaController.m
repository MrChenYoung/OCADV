...
#import "HYReactiveCocoaController.h"
#import "HYRACView.h"

@interface HYReactiveCocoaController ()

@property (nonatomic, strong) HYRACView *racView;

@end

@implementation HYReactiveCocoaController
...
- (void)viewDidLoad {
    ...
    // 添加子视图
    self.racView = [[HYRACView alloc]init];
