...
@interface SocketCoreFoundationServer ()
...
@property (nonatomic, strong) SocketClientModel *currentClientModel;

@end

@implementation SocketCoreFoundationServer
...
{
    char buff[2048];
    SocketCoreFoundationServer *server = (__bridge SocketCoreFoundationServer *)clientCallBackInfo;
...
void TCPServerAcceptCallBack(CFSocketRef socket, CFSocketCallBackType type, CFDataRef address, const void *data, void *info)
{
    ...
    if (kCFSocketAcceptCallBack == type) {
        SocketCoreFoundationServer *sockServer = (__bridge SocketCoreFoundationServer *)info;
