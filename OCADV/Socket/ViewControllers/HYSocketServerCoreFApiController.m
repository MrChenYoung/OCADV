...
@interface HYSocketServerCoreFApiController ()

// 服务端socket
@property (nonatomic, strong) HYSocketCoreFoundationServer *socketServer;
@end

@implementation HYSocketServerCoreFApiController
...
- (void)initServerSocket
{
    ...
    self.socketServer = [[HYSocketCoreFoundationServer alloc]init];
    // 收到客户端发送的消息回调
