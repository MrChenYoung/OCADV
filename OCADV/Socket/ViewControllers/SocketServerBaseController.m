...
#import "SocketServerBaseController.h"
...
@interface SocketServerBaseController ()

// 主视图
@property (nonatomic, strong) SocketServerView *serverView;
...
@implementation SocketServerBaseController
...
- (void)createSubViews
{
    ...
    self.serverView = [[SocketServerView alloc]init];
    // 开始监听
