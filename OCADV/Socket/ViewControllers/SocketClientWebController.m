...
@interface SocketClientWebController ()

// socket
@property (nonatomic, strong) SocketWebSocketClient *socket;

@end

@implementation SocketClientWebController
...
- (void)initSocket
{
    ...
    self.socket = [[SocketWebSocketClient alloc]init];
