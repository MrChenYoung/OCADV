...
#import "HYSocketCocoaAsyncClient.h"

@interface HYSocketClientCocoaAsyncController ()

// 客户端socket2
@property (nonatomic, strong) HYSocketCocoaAsyncClient *socketCocoaAsyncClient;

@end

@implementation HYSocketClientCocoaAsyncController
...
- (void)initSocket
{
    ...
    self.socketCocoaAsyncClient = [[HYSocketCocoaAsyncClient alloc]init];
    // 收到服务器发送的消息回调
